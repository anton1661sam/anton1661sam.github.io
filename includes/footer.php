      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <li><a href="page.php?type=aboutus">О нас</a></li>
            ...
            <li><a href="page.php?type=privacy">Политика конфиденциальности</a></li>
          ...
          <div class="newsletter-form">
            <form method="post">
              <div class="form-group">
                <input type="email" name="subscriberemail" class="form-control newsletter-input" required placeholder="Ваша электронная почта" />
              </div>
