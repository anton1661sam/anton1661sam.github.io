      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Лучшие авто для вас.</h1>
            <p>У нас есть машины на любой вкус. </p>
            <a href="#" class="btn">Еще <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center"  style="color:#FFCC00;">
      <h2>Лучшие авто <span>только для вас</span></h2>
    </div>
    <div class="row"> 
...
<span class="price">$<?php echo htmlentities($result->PricePerDay);?> /в день</span> 
</div>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            ...
            <p>Удовлетворенных покупателей</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Наши благодарные клиенты</h2>
    </div>
    <div class="row">
